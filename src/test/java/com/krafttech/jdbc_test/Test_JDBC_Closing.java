...
public class Test_JDBC_Closing {
    public static void main(String[] args) {
         ...
         * catch bloğu dışında da finally blok oluturarak üç connection ı null değilse (resultSet != null vd.) kapat
         * komutu ile kapattık. tabi bu connectionlar try/catch in dışına çıktığı için main methoda SQL EXCEPTİON
         * throws yaptık. Closing_2 sınıfında ise connectionları kapatmak için best practice uygulayarak try bloğu
         * içinde () parantez içinde sanki try bloğunun parametresi gibi tanımladık ve böylece finally bloğa ihtiyaç
         * duymadan otomatik olarak connectionları kapatabildik.
